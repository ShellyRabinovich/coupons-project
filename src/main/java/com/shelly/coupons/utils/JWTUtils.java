...
public class JWTUtils {
    ...
    public static Claims decodeJWT(String jwt) {
        ...
        Claims claims = Jwts.parser()
                .setSigningKey(DatatypeConverter.parseBase64Binary(Const.JWT_KEY))
    ...
    public static String createJWT(UserData userData) throws JsonProcessingException {
        ...
        String strUserType= String.valueOf(userData.getUserType());
        String strUserId = String.valueOf(userData.getId());
        String strCompanyId= String.valueOf(userData.getCompanyId());
    ...
    private static String createJWT(String id, String userType, String subject, String companyId, long ttlMillis) {
        ...
        byte[] apiKeySecretBytes = DatatypeConverter.parseBase64Binary(Const.JWT_KEY);
